...
- Do not hand-edit anything inside a managed block or under `.claude/rules/`; re-run
  `harness-init` instead. Edits there are overwritten on the next run and drift the manifest.

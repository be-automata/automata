...
| HATCHET_IT=1 pnpm --filter @terragon/worker exec vitest run --no-file-parallelism src/agent-run/supersede.integration.test.ts src/agent-run/scheduling-health.integration.test.ts src/agent-run/box-lock.test.ts | worker supersede-policy E2E, scheduling-health IT, and the kernel box-lock drills against dockerized hatchet-lite |

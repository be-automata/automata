...
| [ADR-007](ADR-007-supersession-authority-and-box-budget.md)  | Supersession authority (engine-only) + the one-agent box budget              | Accepted (Stage B1 live-proven; Stage B2 #184 pending; memory ceiling deferred) |
